...
* Infowindow for the marker or the list view entree which shows the name, address, thumbnail(if available), Average cost for two, user rating and the menu url
